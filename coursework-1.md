...
```
Создал на облаке Yandex Cloud:

netology
Running

Intel Ice Lake	2	20 %	2 ГБ	да	15 ГБ	
ru-central1-a
10.128.0.17
178.154.221.178
06 апреля 2022, в 22:48	
fhm6amfd538ek4jf6fuf

```

2. Установите ufw и разрешите к этой машине сессии на порты 22 и 443, при этом трафик на интерфейсе localhost (lo) должен ходить свободно на все порты.
```
root@netologyautolab72:/home/autolab72# ufw status
Status: inactive
root@netologyautolab72:/home/autolab72# ufw enable
Command may disrupt existing ssh connections. Proceed with operation (y|n)? n
Aborted
root@netologyautolab72:/home/autolab72# ufw default deny incoming
Default incoming policy changed to 'deny'
(be sure to update your rules accordingly)
root@netologyautolab72:/home/autolab72# ufw default allow outgoing
Default outgoing policy changed to 'allow'
(be sure to update your rules accordingly)
root@netologyautolab72:/home/autolab72# ufw allow OpenSSH
Rules updated
Rules updated (v6)
root@netologyautolab72:/home/autolab72# ufw allow 22
Rules updated
Rules updated (v6)
root@netologyautolab72:/home/autolab72# ufw allow 443
Rules updated
Rules updated (v6)
root@netologyautolab72:/home/autolab72# ufw enable
Command may disrupt existing ssh connections. Proceed with operation (y|n)? y
Firewall is active and enabled on system startup
root@netologyautolab72:/home/autolab72#
root@netologyautolab72:/home/autolab72#
root@netologyautolab72:/home/autolab72# ufw status
Status: active
...
$ sudo apt-add-repository "deb [arch=amd64] https://apt.releases.hashicorp.com $(lsb_release -cs) main" (эта команда не заработала, т.к. блокировка стоит, пришлось скачать архив с яндекс облака через wget, распаковать и добавить путь в переменную $PATH)
autolab72@netologyautolab72:~$ echo $PATH
/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/home/autolab72/vault/
autolab72@netologyautolab72:~$ vault
